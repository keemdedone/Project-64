...
class AddMangasGamesRecommandsToTable extends Migration
{
    ...
    public function up()
    {
            ...
            DB::table('recommands')->insert(
                array(
                    'id' => '1',
                    'name' => 'Top 5 GAME Recommand!!!',
                    'type' => 'Game',
                    'review_by' => 'Komchan Thongsen',
                    'description' => '    วิดีโอเกมเป็นสิ่งที่มากเกินไปที่จะถูก จำกัด โดยแนวคิดเกี่ยวกับความเกี่ยวข้องสากล เกมอาจเป็นการผจญภัยและปริศนาและวาล์วปลดปล่อยสำหรับความกังวลและความหงุดหงิดของเรา พวกเขาสามารถเป็นเครื่องมือสำหรับการสื่อสารและพื้นที่ทดลองสำหรับการค้นพบตัวเอง พวกเขาสามารถเป็นกีฬา สิ่งเหล่านี้อาจเป็นอันตรายกระตุ้นให้คุณเล่นการพนันโดยไม่ต้องจ่ายเงินและใช้เวลาว่างทุกมิลลิวินาที หรือคุณก็รู้ว่าแค่พักจากกะกลางคืนสักห้านาที พวกเขาสามารถเป็นศิลปะ พวกเขาสามารถผายลมได้

                    วิดีโอเกมเป็นสื่อที่รวมสื่ออื่น ๆ ทั้งหมดผสมผสานศิลปะกับภาพยนตร์และดนตรีและทุกสิ่งทุกอย่างเข้าด้วยกันเป็นส่วนผสมที่เป็นไปไม่ได้ที่จะสรุปได้ ไม่ใช่แค่สื่อสร้างสรรค์ แต่เป็นสื่อสร้างสรรค์ และเพื่อให้พื้นที่วิดีโอเกมเติบโตขึ้นเรื่อย ๆ เราในฐานะผู้ชมและผู้สร้างจะต้องเหมือนกันต้อนรับทุกคนภายใต้เต็นท์ไม่ว่าพวกเขาจะชอบเลี้ยงสัตว์ในป้อมคนแคระหรือ FarmVille เพื่อสร้างสิ่งที่ไม่สามารถกำหนดได้',
                )
            );
            ...
            DB::table('recommands')->insert(
                array(
                    'id' => '2',
                    'name' => 'Top 5 MANGA Recommand!!!',
                    'type' => 'Manga',
                    'review_by' => 'Komchan Thongsen',
                    'description' => '     ในขณะที่การ์ตูนอาจได้รับความนิยมโดยไม่มีการเผยแพร่เกิดขึ้นในปี 2020 แต่มังงะก็ยังคงเติบโต ด้วยชื่อเรื่องทั่วทั้งโชเน็นและโชโจปี 2020 ได้นำเรื่องราวดีๆมาสู่สหรัฐอเมริกาด้วยการตีพิมพ์คำแปลภาษาอังกฤษของพวกเขา ในการสร้างรายชื่อการ์ตูนยอดนิยมในปี 2020 ข้อกำหนดคือต้องเป็นชื่อที่มีการตีพิมพ์หนึ่งเล่มหรือมากกว่าในฉบับแปลภาษาอังกฤษในสหรัฐอเมริกา แม้ว่าบางส่วนของชื่อเหล่านี้จะมีหลายร้อยบทที่เผยแพร่บนแอป Shonen Jump แต่เรามุ่งเน้นไปที่ปริมาณที่รวบรวมได้เนื่องจากเป็นหนังสือที่ผู้ชมทั่วไปสามารถเข้าถึงได้ง่ายที่สุด
